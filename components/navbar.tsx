...
export function Navbar() {
  ...
  return (
    <>
      ...
      >
        <nav
          className="flex items-center justify-between px-6 py-4 rounded-xl backdrop-blur-sm"
          style={{
            backgroundColor: "rgba(248, 237, 227, 0.95)",
          }}
        >
          {/* Brand/Logo */}
          ...
          >
            <button
              className="px-6 py-3 text-base font-normal transition-all"
              style={{
                fontFamily: "Archivo, sans-serif",
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute top-4 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] rounded-xl backdrop-blur-sm"
              style={{
                backgroundColor: "rgba(248, 237, 227, 0.98)",
              }}
            >
              ...
              <div className="flex flex-col items-center py-12 px-6 space-y-8">
                {["About", "Projects", "News"].map((item, index) => (
                  ...
                  >
                    <Link
                      href={`/${item.toLowerCase()}`}
                      className="text-xl font-normal transition-opacity"
                      style={{
                        fontFamily: "Archivo, sans-serif",
                        color: "rgb(141, 73, 58)",
                      }}
                ...
                >
                  <button
                    className="px-8 py-3 text-base font-normal transition-all rounded-lg"
                    style={{
                      fontFamily: "Archivo, sans-serif",
                      backgroundColor: "rgb(141, 73, 58)",
                      color: "rgb(248, 237, 227)",
